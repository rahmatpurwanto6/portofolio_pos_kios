    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="{{ asset('assets') }}/index2.html" class="logo">
                ...
                <span class="logo-mini"><b>My Shop</b></span>
            ...
            <nav class="navbar navbar-static-top">
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <a href="{{ route('logout') }}"
                                onclick="event.preventDefault(); document.getElementById('logout-form').submit(); return confirm('Apakah anda yakin akan keluar?');">
            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                    <div class="pull-left image">
                        <img src="{{ asset('img/user-profile.jpg') }}" class="img-circle" alt="User Image">
                    </div>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2023 <a>Rahmat Purwanto</a>.</strong>
        </footer>
